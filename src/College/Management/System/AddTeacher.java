...
public class AddTeacher extends JFrame implements ActionListener {
    ...
    AddTeacher() {
        ...
        lblsname.setBounds(50, 150, 100, 30);
        lblsname.setFont(new Font("serif", Font.BOLD, 30));
        add(lblsname);
        ...
        String course[] = {"BTech", "BBA", "BCA", "BSc", "Msc", "MBA", "MCA", "MCom", "BA", "MA"};
    ...
    public void actionPerformed(ActionEvent ae)
    {
        if(ae.getSource() == submit){
            ...
            try{
                ...
                String query = "insert into addTeacher value('"+sname+"' , '"+fname+"' , '"+rollno+"' , '"+dob+"' , '"+address+"','"+phone+"','"+email+"','"+x+"','"+xii+"','"+addhar+"','"+qualification+"','"+branch+"')";
